            ...
            <template #content class="flex justify-center">
                ...
                <div class="flex justify-center">
                    <UButton
                        ...
                        color="error"
                        @click="deleteProject(tempModalProjectID)"
                        loading-auto
                        :dismissible="false"
                        non-dismissible
                        >Tak</UButton
    ...
    <div v-else class="h-full">
        ...
        >
            ...
            >
                <UDropdownMenu
                    :items="dropdownItems(item)"
                    class="flex absolute right-2 top-3"
                >
                    <UButton
                        icon="lucide:more-vertical"
                        color="neutral"
